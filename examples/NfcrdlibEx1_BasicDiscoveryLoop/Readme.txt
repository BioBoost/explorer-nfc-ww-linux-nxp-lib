...
1. DOCUMENT PURPOSE:
    ...
    NfcrdlibEx1_BasicDiscoveryLoop package as well as known problems and restrictions.
...
2. DESCRIPTION:
    ...
    Whenever multiple technologies are detected, example will select first detected
    technology to resolve.
    This example will activate device at index zero whenever multiple device is detected.
...
4. CONFIGURATIONS in Example-1:
    ...
    receives ATR_REQ or RATS from a NFC Peer/Reader. Additional functionality is
    currently not supported in this example.
...
5. PACKAGE CONTENTS:
    ...
    e) NfcrdlibEx1_BasicDiscoveryLoop.c
            Main example file.
    f) Readme.txt 
            This readme file
...
7. HARDWARE CONFIGURATIONS:
    Before starting the application present at NfcrdlibEx1_BasicDiscoveryLoop ensure
...
9. STEPS TO FOLLOW:
    ...
    e) When this application is running on LPC1769+ NFC Reader boards supported setup
       and when you bring the NFC cards or phone in proximity, the example application
       will detect and reports the NFC techonology types detected.
